...
class CompletenessProcessor(DatametricProcessor):
    ...
    def __init__(self, name: str = "completeness", config: Optional[dict[str, Any]] = None) -> None:
        """
    ...
    def compute_features(self, batch: pa.RecordBatch, prev_features: Optional[dict[str, pa.Array]] = None) -> dict[str, pa.Array]:
        """
    ...
    def compute(self, batch_metrics: Optional[dict[str, pa.Array]] = None) -> dict[str, Any]:
        ...
        for col in columns_analyzed:
            ...
            if col_total > 0:
                completeness_score = col_complete / col_total
            else:
        ...
        metadata = {
            ...
            "overall_score": sum(per_column_completeness.values()) / len(per_column_completeness) if per_column_completeness else 0.0
        }
